...
export default function Layout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  const sidebarVariant = "inset" as SidebarVariant;
  const sidebarCollapsible = "icon" as SidebarCollapsible;
  const contentLayout = "centered" as ContentLayout;
  const navbarStyle = "scroll" as NavbarStyle;
